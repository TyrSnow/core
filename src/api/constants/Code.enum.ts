...
const CODE = {
    ...
    DUMPLICATE_NAME: C(21001, '用户名已经被注册'),
    DUMPLICATE_PHONE: C(21002, '手机号已经被注册'),
    DUMPLICATE_EMAIL: C(21003, '邮箱已经存在'),
    ILLEGAL_PASSWORD: C(21004, '非法的密码格式'),
    ILLEGAL_USERNAME: C(21005, '非法的用户名'),
}
